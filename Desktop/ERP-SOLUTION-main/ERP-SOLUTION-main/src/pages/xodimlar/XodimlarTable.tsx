  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-3 md:flex-row md:justify-between md:items-center px-4">
        ...
        <Link to="/xodimlar/form" className="flex items-center cursor-pointer border h-[36px] rounded-xl justify-center bg-white/70 backdrop-blur-xl border-gray-300 shadow-[rgba(0,0,0,0.24)_0px_3px_8px] px-3">
      ...
      <div className="px-4 mt-4">
        <div className="text-sm text-gray-500 pb-2">
          {loading ? "Loading..." : `${rows.length} ta mijoz topildi`}
        </div>
