...
export default function Orders() {
  return (
    <div className="glav-font ">
        <div>
         <h2 className='text-[35px] text-white  font-bold mt-4 mb-8'> Orders Kanban Board</h2> 
         <div className='w-full    glass
   rounded-lg max-w-auto h-[56px] bg-transparent  flex gap-2 items-center justify-start pl-4'>
         ...
         <p className='text-white'>Failed to load some orders. Please refresh or try again later.</p></div>
        </div>
