...
import { registerUser } from "@/pages/shared/auth/storage"
...
export default function RegisterPage() {
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // registerdan keyin login page ga o‘tsin
    ...
    <div className="rounded-2xl bg-white shadow-[0_24px_90px_-40px_rgba(0,0,0,0.45)] border border-black/5 overflow-hidden">
      ...
      <form onSubmit={onSubmit} className="p-6">
        <div className="text-center text-slate-500 text-xs mb-6">
          Create your account to access CRM.
        </div>
        ...
        <label className="block mb-3">
          <div className="text-xs font-bold text-slate-700 mb-2">Full Name</div>
          <input
